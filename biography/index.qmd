...
work as a program chair and general chair for workshops and conferences. As a
member of software engineering teams, I create useful research
[software](/software/index.qmd) for the purposes of experimentation,
replication, and technology transfer.

I collaboratively publish papers like [@Walsh2017] [{{< iconify
fa6-solid book-open
...
with me on a research, software engineering, or educational project or appearing
as a guest on the [Software Engineering Radio](https://www.se-radio.net/)
podcast? If so, then please [contact](/contact/index.qmd) me to share your
ideas!
