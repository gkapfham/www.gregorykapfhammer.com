...
Associate Professor in the <a href="http://www.cs.allegheny.edu">Department of
  Computer and Information Science</a> at <a href="http://www.allegheny.edu">Allegheny
...
acquired by <a href="https://www.synopsys.com/">Synopsys</a>. My professional work is
...
As an educator, I teach [courses](/teaching/index.qmd) in areas such as
algorithm analysis, computation theory, discrete structures, data management,
distributed systems, software engineering, software testing, operating systems,
and web development. I am also a research adviser for undergraduate and graduate
theses and PhD dissertations. My expertise in teaching was recognized when
Allegheny College presented me with the [Thoburn Award for Excellence in
...
[software](/software/index.qmd) for the purposes of
running novel experiments, replicating empirical studies, and transferring technology to industry.
...
I leveraged my scientific and engineering expertise to serve the following
recent venues:
...
with me on a research, software engineering, or educational project? If you
answered "yes" to one or more of these questions, then I invite you to
[contact](/contact/index.qmd) me to share your ideas! You can also learn more
about my [research](/research/index.qmd), check out my
[papers](/research/papers/index.qmd) or
[presentations](/research/presentations/index.qmd), or explore the ways in
which I use my technical expertise to [serve](/service/index.qmd) the software
...
My technical expertise and communication skills enabled these media engagements:
...
## Media Invitation
 ...
 Do you think that your knowledge and skills equip you to be a guest on the
 [Software Engineering Radio](https://www.se-radio.net/) podcast that I
 co-host? Or, would you like me to be a guest on a podcast that you host? If
 so, then I hope that you will [contact](/contact/index.qmd) me to share your
 ideas!
