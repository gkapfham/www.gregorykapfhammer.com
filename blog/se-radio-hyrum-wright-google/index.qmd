...
description: <em>How do Google engineers innovate?</em>
---
...
discussed various aspects of software engineering practices at Google, including
testing, static analysis, large-scale code changes, and the importance of time,
scale, and trade-offs. I'm thankful that Hyrum took the time to participate in
this discussion! Here are some key insights from it:
...
<p class="podcast-paragraph">
  {{< fa headphones >}} Listen to the episode [Hyrum Wright on Software Engineering at Google](https://se-radio.net/2024/03/se-radio-609-hyrum-wright-on-software-engineering-at-google/) from [Software Engineering Radio](https://se-radio.net/) for more insights!
</p>
