...
description: Create papers and presentations like software
...
papers and presentations in [LaTeX](http://www.latex-project.org/) with the
[Vim](http://www.vim.org/) text editor &mdash; a task I also find to be
