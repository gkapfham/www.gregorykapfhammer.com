...
The paper presents techniques for statically analyzing schema mutants,
identifying those that are ineffective, and removing them from the mutant pool
used in mutation analysis. These algorithms are implemented in our open-source
tool called SchemaAnalyst. Our experimental study shows that these algorithms
can detect and remove large numbers of ineffective mutants, making mutation
