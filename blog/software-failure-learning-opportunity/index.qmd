...
later I'm still delighted to use Linux!
...
emails, Markdown, HTML, CSS, JavaScript, LaTeX, Python, R, Java, and more. Yes,
I write my email in Neovim!
...
using SCCS and RCS, I became frustrated when using them in a team setting,
...
GitHub Classroom for my teaching and research!
...
Do you have experiences with software failure? Have you seen the benefits of a
program no longer meeting your needs? If you have, then I invite you to
[contact](/contact/) with your thoughts. Do you want to be updated when I
publish new blog posts? If you do, then please [subscribe](/support/) to my
mailing list.
