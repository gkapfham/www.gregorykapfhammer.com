...
[papers](/research/papers/), and implement [software](/software/). <span
  class="gist">Given the rapid pace of innovation in the field of software
  engineering, I thought that it would be a good idea to share a status update
  on my use of some software that I suggested in previous posts. But, be more
  software tool changes are likely!</span>

- In the article [Distraction-free writing with a terminal timer and Ubuntu
notifications](/blog/distraction-tree-terminal-timer/index.qmd), I suggested
...
3](/blog/virtual-environments-python-three/index.qmd), I suggested the use of
...
with better performance. Again, you can check my `.vimrc` and `.zshrc` files in
my [dotfiles](https://github.com/gkapfham/dotfiles) to learn how I configured
these and other command-line tools.
