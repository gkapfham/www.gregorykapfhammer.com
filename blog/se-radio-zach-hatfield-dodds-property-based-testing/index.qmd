...
at Anthropic, an artificial intelligence (AI) safety and research company. He is
also known for his contributions to open source projects like `Hypothesis`,
`Pytest`, and `HypoFuzz`. We discussed property-based testing and how it can be
effectively implemented using `Hypothesis`, an advanced testing library for
Python. I'm really thankful that Zac took the time to share his knowledge with
me!
