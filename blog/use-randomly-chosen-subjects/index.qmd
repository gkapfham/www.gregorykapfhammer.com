...
<span class="gist">Many types of software engineering research require software
  subjects that a researcher can use during an experimental evaluation of a
  technique.</span> For instance, if you develop a new way to test software,
then you need to demonstrate that it can effectively find defects in real-world
programs. So, where will you find these programs? And, how can you select the
...
their technique is likely to perform well.

<span class="gist">This sounds like a thorny problem! Are there any viable
  solutions? Well, yes!</span>
...
book-open >}}](/research/papers/walsh2017/index.qmd). <span class="gist">The
  benefits associated with using randomly chosen subjects in our research is
  that now we can have more confidence in the results that demonstrate the
  efficiency and effectiveness of our approach.</span>
