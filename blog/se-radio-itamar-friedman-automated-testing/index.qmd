...
design, implementation, use, and future of
[Qodo-Cover](https://github.com/qodo-ai/qodo-cover/tree/main), an open-source
tool that automatically generates tests to increase the coverage of an existing
test suite.
