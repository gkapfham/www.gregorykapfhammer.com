...
title: Using Major to perform mutation analysis of test suites for Java programs
date: '2014-01-01'
date-format: YYYY
categories: [post, mutation testing, software tool]
description: Have a JUnit test suite? Use Major to assess its quality!
...
href="http://www.mutation-testing.org">Major</a>, a compiler-integrated
mutation testing tool for the Java programming language. You can learn more
about Major by reading [@Just2011a] [{{< iconify fa6-solid book-open
...
about mutation testing, with two of the most noteworthy being [@McCurdy2016]
