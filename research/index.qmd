...
My most recent work in this area advocates for researchers and developers to go
beyond any individual metric of "good" or "bad" tests --- like test flakiness
--- as it argues for a more holistic view test suite health [@McMinn2025] [{{<
...
Finally, recent work explores how eXtreme mutation testing (XMT) and statement
deletion (SDL) mutation operators can detect pseudo-tested statements in a
Java program
[@Maton2024] [{{< iconify fa6-solid book-open >}}](/research/papers/mcminn2019/index.qmd).
