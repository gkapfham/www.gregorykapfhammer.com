...
[software](/software/). <span class="gist">My research focuses on software
    engineering and software testing, examples of which are summarized in these
...
tests are most likely to be flaky
...
{% include _popovers/paper_reference.html cite="Parry2020"
trailing="," %}

my colleagues and I also published a survey of the literature
relevant to flaky test research 

{% include_cached _popovers/paper_reference.html
cite="Parry2022" %}

and a multi-source investigation into how developers
experience the impacts and causes of flaky tests
