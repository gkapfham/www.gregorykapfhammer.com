...
console = Console()
console.print(
    f":rocket: Explore my research in fields like testing and debugging!"
)
```
...
useful free and open-source [software]({{site.baseurl}}software/). My research
...
please [contact]({{site.baseurl}}contact/) me soon!
