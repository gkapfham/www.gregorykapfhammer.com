...
console.print(
    f":rocket: I'm thankful for the opportunity to serve these {service_count} different venues!"
)
```
...
contributing to open-source [software](software/), I collaborate with people at
leading academic institutions, government agencies, and technology companies.
