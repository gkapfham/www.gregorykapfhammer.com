...
- [Mutation Testing](research/index.qmd#mutation-testing): Detecting and
repairing responsive web page layout

- [Regression Testing](research/index.qmd#regression-testing): Detecting and
repairing responsive web page layout
