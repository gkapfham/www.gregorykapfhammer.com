...
of for presentations like [@Kapfhammer2021] [{{< iconify fa6-solid book-open
...
create and layout the graphical content!
...
presentations](/research/papers/index.qmd). For instance, you can review
all of the survey data from [@Parry2022b] [{{< iconify fa6-solid book-open
>}}](/research/papers/parry2022b/index.qmd) and use all of the tooling used to
run the experiments that we report on in [@Alsharif2020] [{{< iconify
fa6-solid book-open
