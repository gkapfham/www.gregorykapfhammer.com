...
presentations](/research/papers/index.qmd). For instance, you can review all of
the survey data from [@Parry2022b] [{{< iconify fa6-solid book-open
...
them from my professional web site's [teaching](/teaching/index.qmd) page. Even
though I no longer maintain out-of-date course content and instead encourage
learners to visit my course platforms, you may [contact me](/contact/) with
your request for old materials.
...
I aim to have a well-documented set of software tools that I run on the laptop
that I use for all of my professional activities. I hope that some of these
configurations can help you to setup your own development workstation!
...
Whenever I can do so, I participate in the maintenance and enhancement of
open-software software tools by reporting defects and participating in
discussions. My aim is to help and encourage the maintainers of these tools!
...
available so that others can use them as a source of inspiration.
